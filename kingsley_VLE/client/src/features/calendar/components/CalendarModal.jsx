...
export default function CalendarModal({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      >
        {/* Calendar panel */}
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-[360px] max-w-[calc(100vw-2rem)] flex flex-col overflow-hidden animate-fadeIn"
          style={{ height: 420 }}>
          {/* Header */}
          <div className="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-[#6b1142] to-[#9a1a5e]">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-white tracking-tight">Academic Calendar</h2>
            </div>
            <div className="flex items-center gap-2">
              {loading && (
      ...
      {selectedDate && (
        <ReminderPopup
          ...
          onClose={() => { setSelectedDate(null); setSelectedReminders([]) }}
        />
      )}
    </>
  )
