...
export default function AssignmentsTab({ courseId, sectionId }) {
  ...
  const { assignments, submittedIds, loading, error, totalCount, totalPages } = useAssignmentsByCourse(
    courseId,
    sectionId,
    currentPage
  )
  ...
  return (
    <>
      ...
      {detailsModal && (
        <DetailsModal assignment={detailsModal} onClose={() => setDetailsModal(null)} />
      )}
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {a.description && (
                        <p className="text-sm text-[#6b1d3e] mt-1 line-clamp-2">{a.description}</p>
                      )}
                    </div>
                  </div>
                  {/* Pending badge */}
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-400">Due: {fmt(a.dueDate)}</p>
                      </div>
                    </div>
