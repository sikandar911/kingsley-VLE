...
export default function CreateAssignmentModal({ onClose, onSaved, editAssignment }) {
  const { user } = useAuth()
  ...
  useEffect(() => {
    assignmentsApi
      ...
      .catch(() => setError('Failed to load form data. Make sure the server is running.'))
              ...
              <div className="space-y-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#6b1142]"
                  />
                  <p className="text-xs text-gray-400 mt-1.5">Leave blank for no deadline</p>
                </div>

                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-sm font-semibold text-gray-900 mb-4">Marks Configuration</h3>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs text-gray-600 mb-1.5">Total Marks *</label>
                      <input
                        type="number"
                        name="totalMarks"
                    ...
                    <div>
                      <label className="block text-xs text-gray-600 mb-1.5">Passing Marks</label>
                      <input
                        type="number"
                        name="passingMarks"
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Allow Late Submission</p>
