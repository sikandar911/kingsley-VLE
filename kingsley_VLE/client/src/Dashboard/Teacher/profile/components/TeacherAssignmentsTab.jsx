        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <span
                className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold capitalize ${STATUS_COLORS[assignment.status] || "bg-gray-100 text-gray-600"}`}
              >
                {assignment.status}
              </span>
            </div>
          </div>
          {Array.isArray(assignment.rubrics) &&
                ...
                <div className="space-y-1">
                  {assignment.rubrics.map((r, i) => (
                    ...
                    >
                      ...
                      <span className="font-semibold text-[#6b1d3e]">
                        {r.maxMarks} pts
                      </span>
                    </div>
                  ))}
...
export default function TeacherAssignmentsTab({ courseId, sectionId }) {
  ...
  const { assignments, loading, error, totalCount, totalPages } =
    useTeacherAssignmentsByCourse(courseId, sectionId, currentPage);
