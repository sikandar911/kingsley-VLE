...
const options = {
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        CourseModule: {
          ...
          properties: {
            id: { type: "string" },
            name: { type: "string", example: "Module 1: Introduction" },
            description: {
              type: "string",
              nullable: true,
    ...
    tags: [
      ...
      {
        name: "Assignments",
        description: "Assignment lifecycle, submissions, and grading endpoints",
      },
      ...
      { name: "Courses", description: "Course management" },
      {
        name: "CourseModules",
        description:
          "Course module management (learning modules within a course)",
      },
      {
        name: "Sections",
      ...
      { name: "Academic", description: "Sessions and Semesters management" },
      {
        name: "Enrollments",
        description:
          "Student enrollment and teacher-course assignment management",
      },
      {
        name: "Files",
        description: "File upload and management via Azure Blob Storage",
      },
      {
        name: "Attendance",
        description: "Student attendance tracking per section/semester",
      },
      {
        name: "ClassMaterials",
      ...
      {
        name: "ClassRecords",
        description: "Class recordings and resource links (URL-based)",
      },
    ],
  },
