              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <div className="space-y-2 sm:space-y-3 pb-4 sm:pb-5 border-b border-[#6b1d3e] flex-grow">
                    ...
                    <div className="flex items-center text-xs sm:text-sm text-gray-600">
                      <GraduationCap className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-gray-400" />
                    ...
                    <div className="flex items-center text-xs sm:text-sm text-gray-600">
                      <UserCheck className="w-4 h-4 sm:w-5 sm:h-5 mr-2 ml-[2px] text-gray-400" />
                  ...
                  <div className="pt-4 sm:pt-5 space-y-2">
                    <button
                      onClick={() =>
                        navigate(
                          `/student/courses/${course.courseId}${course.sectionId ? `?sectionId=${course.sectionId}` : ""}`,
                        )
                      }
